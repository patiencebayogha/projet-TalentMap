...
import com.viseo.talentmap.lite.MyMultipartEntity;
...
public class HttpUploader extends AsyncTask<Void, Integer, Void> {
    ...
    private static final String SERVER_URL_API = "http://tml.hubi.org:80/api/v1";

    public HttpUploader(Context context, String imgPath) {
        super();
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            HttpPost post = new HttpPost(SERVER_URL_API);
