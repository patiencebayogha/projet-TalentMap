package com.example.pba3360.projetcouchbase.gsonRequest;
...
public class GsonRequestGet <T> extends Request<T> {
    ...
    private Map<String, String> headers = null;   //Map of request headers
    ...
    public GsonRequestGet(int method, String url, Class clazz,
