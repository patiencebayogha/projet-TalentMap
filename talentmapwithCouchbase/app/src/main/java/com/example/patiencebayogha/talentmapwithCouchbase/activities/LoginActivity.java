...
import com.example.patiencebayogha.talentmapwithCouchbase.data.LoginUser;
import com.example.patiencebayogha.talentmapwithCouchbase.gsonRequest.LoginGsonRequest;
import com.example.patiencebayogha.talentmapwithCouchbase.preferences.TalentPreferences;
    ...
    *permit to convert email and password to string
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (seSouvenirDeMoi.isChecked()) {
                    ...
                    Snackbar snackbar = Snackbar.make(v, "Email save",
                            ...
                            .setAction("Annuler", mOnClickListener);
        ...
        mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                seSouvenirDeMoi.setChecked(false);
            }
        };
        ...
        return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext(),
                        error.getMessage() + ", " + " " + "Erreur durant le chargement", Toast.LENGTH_LONG).show();
