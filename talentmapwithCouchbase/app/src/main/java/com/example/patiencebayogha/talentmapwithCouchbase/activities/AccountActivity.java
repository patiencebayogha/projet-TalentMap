...
import com.example.patiencebayogha.talentmapwithCouchbase.data.AccountUser;
        ...
        return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError e) {
                ...
                Toast.makeText(getApplicationContext(),
                        e.getMessage() + " "  + "erreur data loading", Toast.LENGTH_LONG).show();
                ...
                if (e instanceof NoConnectionError) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + " " + "Erreur de connexion.......", Toast.LENGTH_LONG).show();

                } else if (e instanceof AuthFailureError) {
                    Log.e("AuthFailureError", "Authification Failure Error.......");
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + " " + "Erreur d'authentification.......", Toast.LENGTH_LONG).show();

                } else if (e instanceof ServerError) {
                    Log.e("ServerError", "Server Error.......");
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + "  " + "Erreur serveur.......", Toast.LENGTH_LONG).show();

                } else if (e instanceof NetworkError) {
                    Log.e("NetworkError>", "Network Error.......");
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + " " + "Erreur réseau.......", Toast.LENGTH_LONG).show();

                } else if (e instanceof ParseError) {
                    Log.e("ParseError", "Parse Error.......");
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + " " + "Erreur d'analyse.......", Toast.LENGTH_LONG).show();

                } else if (e instanceof TimeoutError) {
                    Log.e("TimeoutError", "Timeout Error.......");
                    Toast.makeText(getApplicationContext(),
                            e.getMessage() + ", " + " " + "Erreur temps.......", Toast.LENGTH_LONG).show();
